...
extern volatile uint32_t dynamic_fb;
extern volatile int64_t feedback_integral;
extern volatile uint32_t current_avail;
extern volatile int32_t smoothed_avail;
extern volatile uint32_t ep1_in_cnt;
