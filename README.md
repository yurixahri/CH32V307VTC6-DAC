the code is a lot of vibe code, i'm familiar with this board platform, UAC2 and stuff... for now the code support 44->96khz for both 16 and 24 bit profile. i have tuned it to be precised because the board alone does not have much option for i2s frequency, i use pll3 (8 Mhz) for i2s. it still have some problem like pop when audio end...

the code is for CH32V307VTC6 development board (around 4.5$, quite cheap), pair with PCM5102. the wire config is:
